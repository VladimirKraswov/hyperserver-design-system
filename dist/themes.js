export const themeNames = ["peach-light", "ember-dark"];
...
export const isTheme = (value) => typeof value === "string" && themeNames.includes(value);
export const normalizeTheme = (value, fallback = "peach-light") => isTheme(value) ? value : fallback;
export const cssVariable = (token) => `--${token}`;
export const loadStoredTheme = (options = {}) => {
